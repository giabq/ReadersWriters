public class testeLeitoresEscritores {
    public static void main(String[] args) {
        System.out.println("Iniciando testes com Readers e Writers...");

        // inicializa a base de dados com o arquivo bd.txt e o controlador com RW
        BD bd = new BD("bd.txt", 1);
        ...
        System.out.println("Iniciando teste sem Readers e Writers...");

        // inicializa a base de dados com o arquivo bd.txt e o controlador sem RW
        BD bd2 = new BD("bd.txt", 0);
